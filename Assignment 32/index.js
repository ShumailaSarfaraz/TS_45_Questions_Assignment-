...
var current_users = ["rehman", "ali", "ahmed", "zahid", "umer"];
var new_users = ["ubaid", "usaid", "rehman", "umer", "akbar"];
for (var _i = 0, new_users_1 = new_users; _i < new_users_1.length; _i++) {
    ...
    if (found) {
        console.log("Username '".concat(new_username, "' is not available. Please enter a new user"));
    }
    else {
